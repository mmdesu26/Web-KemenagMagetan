...
import { FaUsers, FaNewspaper, FaList, FaEye, FaCalendarAlt, FaChartLine, FaTrendingUp, FaClock } from "react-icons/fa"
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {statsCards.map((card, index) => (
              ...
              >
                <Card
                  className={`border-l-4 ${colorClasses[card.color as keyof typeof colorClasses].split(" ")[0]} hover:shadow-xl transition-all duration-300 overflow-hidden relative`}
                >
                  <div
                  ...
                  <CardContent className="relative z-10">
                    ...
                    <p className="text-xs text-gray-600 mt-1 flex items-center">
                      <FaTrendingUp className="mr-1 text-green-500" />
                      {card.desc}
                    </p>
                  </CardContent>
                </Card>
          ...
          >
            <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-gray-50">
              <CardHeader className="bg-gradient-to-r from-green-50 to-green-100 border-b">
                ...
                <CardDescription>Artikel yang baru ditambahkan atau diperbarui</CardDescription>
              </CardHeader>
                  ...
                  {recentNews.map((news, index) => (
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500 mt-1">{new Date(news.date).toLocaleDateString("id-ID")}</p>
                      </div>
